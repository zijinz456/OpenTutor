...
export function StreamingIndicator() {
  return (
    <span role="status" aria-live="polite" className="inline-flex items-center gap-1.5 rounded-2xl bg-muted/30 px-3 py-2 animate-fade-in" aria-label="AI is thinking">
