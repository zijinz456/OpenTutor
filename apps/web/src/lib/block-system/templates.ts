...
export const LEARNING_MODES: Record<LearningMode, LearningModeDefinition> = {
  ...
  self_paced: {
    ...
    name: "Self-Paced",
    nameZh: "自学模式",
    description: "Exploration-driven. Knowledge graph and topic-based learning.",
    descriptionZh: "以探索为驱动，知识图谱与主题式学习。",
    icon: "Compass",
    columns: 2,
    blocks: [
      b("knowledge_graph", "large"),
  ...
  exam_prep: {
    ...
    name: "Exam Prep",
    nameZh: "备考模式",
    description: "Practice-heavy. Focus on weak spots and timed practice.",
    descriptionZh: "大量练习，聚焦薄弱点和限时训练。",
    icon: "Clock",
    columns: 2,
    blocks: [
      b("quiz", "large", { difficulty: "hard" }),
