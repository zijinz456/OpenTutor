"""Prompt constants and keyword detectors for TutorAgent.

Contains:
- Regex patterns for intent detection (quiz, review, assess, curriculum, code, fatigue)
- Teaching strategy fragment loader
- All conditional prompt section texts
- Learning mode instructions

Extracted from tutor.py.
"""
