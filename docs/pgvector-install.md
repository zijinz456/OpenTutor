...
psql postgres -c "CREATE ROLE opentutor WITH LOGIN PASSWORD 'opentutor_dev';"
...
sudo -u postgres psql -c "CREATE ROLE opentutor WITH LOGIN PASSWORD 'opentutor_dev';"
...
4. Create the database:
   ```sql
   -- In pgAdmin or psql:
   CREATE ROLE opentutor WITH LOGIN PASSWORD 'opentutor_dev';
...
# postgresql+asyncpg://opentutor:opentutor_dev@localhost:5432/opentutor
```
